...
from docusign_esign import ApiClient, EnvelopesApi, EnvelopeDefinition, Signer, SignHere, Tabs, Recipients, Document, RecipientViewRequest, ServerTemplate, InlineTemplate, CompositeTemplate

# Settings
# Fill in these constants
#
# Obtain an OAuth access token from https://developers.hqtest.tst/oauth-token-generator
access_token = os.environ["DOCUSIGN_OAUTH"]
# Obtain your accountId from demo.docusign.com -- the account id is shown in the drop down on the
# upper right corner of the screen by your picture or the default picture.
account_id = os.environ["DOCUSIGN_ACC_ID"]
# Recipient Information:
signer_name = 'Alice Chang'
signer_email = 'changvalice@gmail.com'
# The document you wish to send. Path is relative to the root directory of this repo.
file_name_path = 'World_Wide_Corp_lorem.pdf'
...
template_ids = [id for id in os.environ["DOCUSIGN_TEMPLATE_IDS"].split(",")]
